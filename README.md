...
- **Build instructions:**
  ...
  - Create segmentation images:
    ...
    - Run segmentation script:
      ...
      ```
  - Construct dataset of resized images of size `256 x 256`:
    ```bash
      python taming/data/resize_data.py
    ```
    If using symlinks, follow the instructions mentioned earlier to link to these files.
